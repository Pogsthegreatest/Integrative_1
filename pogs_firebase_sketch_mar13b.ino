...
const char* firestoreUrl = "https://firestore.googleapis.com/v1/projects/pogs-f1e2f/databases/(default)/documents/sensor_data?key=AIzaSyCDk6dZlG2koWWpaELd3v7WUSLrTFwe1Ng";
...
void loop() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    int daylight = (photoresistorValue > 400) ? 1 : 0;  
